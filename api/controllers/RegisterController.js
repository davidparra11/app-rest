...
module.exports = {
    ...
    //attemp to get the users from our databases when pass array of agenda numbers from Ios.
    getFriendsIos: function (req, res) {
        ...
        var agenda = utils.convertStringIos(req.param('agenda'));
